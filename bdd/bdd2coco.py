# Purpose: convert bdd (scalabel) format to coco format

# '''
# python bdd2coco.py -l /home/aghosh/Projects/2PCNet/Datasets/bdd100k_ori/labels/det_20 -s /home/aghosh/Projects/2PCNet/Datasets/bdd100k_ori/labels/det_20
# '''
...
def bdd2coco_detection(id_dict, labeled_images, fn):
    ...
    # Define the categories (NOTE: hardcode for now)
    categories = [
    ...
    for i in tqdm(labeled_images):
        ...
        if 'labels' in i:  # Check if 'labels' key exists in the dictionary
    ...
    attr_dict["categories"] = categories  # <- ADDED this line
...
if __name__ == '__main__':
    ...
    attr_dict = dict()
    # NOTE: these labels are for det20 jsons only
...
# # Try scalabel for now (not working!!!!!!!!!!!!!!!!!!!!)
# '''
# python3 -m scalabel.label.to_coco \
#     --input /home/aghosh/Projects/2PCNet/Datasets/bdd100k_ori/labels/det_20/det_val.json \
#     --output /home/aghosh/Projects/2PCNet/Datasets/bdd100k_ori/labels/det_20/det_val_coco.json \
#     --config config.json
# '''
