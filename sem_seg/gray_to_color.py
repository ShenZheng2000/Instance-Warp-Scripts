...
def process_dataset(source_dir, target_dir):
    ...
    for filename in os.listdir(source_dir):
        # NOTE: must be this surfix!!!!!!!!!!!!!!!
        if filename.endswith('_labelTrainIds.png'):  # or any other file extension
            source_file = os.path.join(source_dir, filename)
            target_file = os.path.join(target_dir, filename)

            # Load, process, and save each image
            gray_semantic_label = load_gray_semantic_label_image(source_file)
            save_colorized_image(gray_semantic_label, target_file)


# Directories
source_dir = "/home/aghosh/Projects/2PCNet/Datasets/synthia/GT/LABELS"
target_dir = "/home/aghosh/Projects/2PCNet/Datasets/synthia/GT/LABELS_CONVERT"
